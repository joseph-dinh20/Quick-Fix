...
import { reportStore, reviewStore } from "@/store/userList.js"
    ...
    try {
        ...
        payload.append(
            ...
            editForm.value.deadline
                ? `${editForm.value.deadline.split("T")[0]}T00:00:00Z`
                : "",
        );
...
<template>
    <div class="min-h-screen bg-slate-0 p-6 md:p-12 font-sans text-slate-900">
        <div class="max-w-4xl mx-auto">
            <h1
                class="text-3xl font-extrabold tracking-tight mb-8 text-[#1a202c]">
                Manage Postings
            </h1>
            ...
            <div
                ...
                <div
                    class="relative w-full sm:w-[450px] flex items-center bg-white rounded-full border border-slate-200 shadow-sm p-1.5">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <Button
                            variant="outline"
                            class="bg-white border-slate-200 text-slate-700 hover:bg-slate-50 rounded-lg flex items-center gap-2 shadow-sm px-4 capitalize">
                            {{ currentSort }}
                            <ChevronDown class="w-4 h-4 text-slate-500 ml-1" />
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent align="end" class="w-40">
                        <DropdownMenuItem @click="updateSort('Newest')"
                            >Newest</DropdownMenuItem
                        >
                        <DropdownMenuItem @click="updateSort('Oldest')"
                            >Oldest</DropdownMenuItem
                        >
                        <DropdownMenuItem @click="updateSort('Title (A-Z)')"
                            >Title (A-Z)</DropdownMenuItem
                        >
                        <DropdownMenuItem @click="updateSort('Status')"
            ...
            <div v-if="jobs.length" class="space-y-4">
                <Card
                    ...
                    <CardContent
                        class="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h2
                                class="font-bold text-[#1a202c] text-[15px] mb-2.5">
                                {{ job.title }}
                            </h2>
                            <div
                                class="flex items-center gap-3 text-slate-500 font-medium pb-2">
                                <svg
                            ...
                            <div
                                class="flex items-center text-slate-500 font-medium">
                                <Calendar
                        ...
                        <div class="flex items-center gap-1">
                            <Button
                                variant="ghost"
                                size="icon"
                                class="text-slate-500 hover:text-slate-900 hover:bg-slate-100 rounded-full"
                            ...
                            <Button
                                variant="ghost"
                                size="icon"
                                class="text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-full"
            ...
            <Dialog :open="isDialogOpen" @update:open="isDialogOpen = $event">
                <DialogContent
                    ...
                    <div
                        v-if="selectedJob"
                        class="p-8 max-h-[85vh] overflow-y-auto">
                        <div class="flex justify-between items-center mb-6">
                            <h2
                                class="text-2xl md:text-3xl font-extrabold text-[#1a202c]">
                                {{ selectedJob.title || "Pest Control Help" }}
                            </h2>
                            <Button
                                variant="ghost"
                                size="icon"
                        ...
                        <div
                            v-if="
                                selectedJob.images && selectedJob.images.length
                            "
                            ...
                            <div
                                ref="carousel"
                                class="flex gap-4 overflow-x-auto snap-x snap-mandatory hide-scrollbar w-full px-4">
                                <div
                        ...
                        <div class="mb-8">
                            <h3 class="font-bold text-[#1a202c] text-lg mb-6">
                                Quick Details
                            </h3>
                            <div
                                ...
                                <div
                                    ...
                                    {{
                                        selectedJob.city +
                                            ", " +
                                            selectedJob.state ||
                                        "Request type not provided"
                                    }}
                                </div>

                                <div
                                    class="flex items-center text-slate-600 font-medium capitalize">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="18"
                                        height="18"
                                ...
                                <div
                                    ...
                                    <svg
                                        ...
                                        <rect
                                            ...
                                            ry="2"></rect>
                                        <path
                                            d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>
                                    </svg>
                                    {{
                                        selectedJob.request_type ||
                                        "Request type not provided"
                                    }}
                                </div>
                        ...
                        <div>
                            <h3 class="font-bold text-[#1a202c] text-lg mb-4">
                                About the Job
                            </h3>
                            <p
                ...
                <DialogContent class="sm:max-w-[600px]">
                    <DialogHeader>
                        <DialogTitle
                            ...
                            >Edit Posting</DialogTitle
                        >
                        <DialogDescription class="text-slate-500">
                            Make changes to your job posting below. Click save
                            when you're done.
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div class="space-y-5 px-1 pb-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-4 gap-3">
                                    ...
                                    <AspectRatio :ratio="1">
                                        <label
                                            class="flex items-center justify-center border-2 border-dashed rounded-lg cursor-pointer hover:bg-slate-50 w-full h-full">
              ...
              <div class="space-y-2">
                ...
                <div class="border-2 border-dashed border-slate-200 rounded-lg p-6 flex flex-col items-center justify-center text-center hover:bg-slate-50 transition-colors">
                  ...
                  />
                    ...
                    <div
                        class="flex justify-end gap-3 mt-4 pt-4 border-t border-slate-100">
                        <Button
                            variant="outline"
                        ...
                        <Button
                            ...
                            class="bg-primary hover:bg-primary text-white font-bold">
                            Save Changes
                        </Button>
                    </div>
                </DialogContent>
