  ...
  <div class="flex flex-col items-center m-10">
    <Card class="max-w-200 min-h-200 min-w-150">
      ...
      <CardContent>
        ...
        <Label v-if="photoList.length > 0" for="workPhotos" class="mt-5 mb-2"
          >Work Photos</Label
        >
          ...
          <div v-for="photo in displayedPhotos">
            <HoverCard :open-delay="50" :close-delay="0">
              <div class="flex flex-col w-25">
                ...
                <Button
                  class="hover:bg-destructive hover:text-white self-center"
                    ...
                    <CarouselContent>
                      <CarouselItem v-for="photo in photoList" :key="photo">
                        <div class="flex flex-col items-center aspect-square">
                          ...
                          <!-- </div> -->
                          <Button
                            class="mt-2 mb-5 w-20 hover:bg-destructive hover:text-white"
                            @click="removePhoto(photo)"
                            variant="outline"
                            >Remove</Button
                          >
