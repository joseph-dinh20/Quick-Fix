          ...
          <div class="flex flex-col gap-4 mt-20">
            <template v-if="stepIndex === 1">
              <FormField v-slot="{ componentField }" name="address">
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="text" v-bind="componentField" placeholder="323 W Salt Lake, Long Beach, CA, 90100" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              </FormField>
              ...
              <Card>
                ...
                <CardContent>
                  <FormField v-slot="{ componentField }" name="plan">
                    <FormItem>
                      <FormLabel class="text-base">Select Hours</FormLabel>
            ...
            <template v-if="stepIndex === 3">
              ...
              <Card class="min-h-full min-w-150">
                <CardHeader>
                  <CardTitlte>Task Description</CardTitlte>
                  <CardDescription>
