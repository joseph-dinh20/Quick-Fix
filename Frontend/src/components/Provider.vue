...
<!--           </div> -->
<!--           <div -->
<!--             v-else-if="provider.workPhotos.length === 0" -->
...
<!--         <div -->
<!--           v-if="provider.ratings.length > 0" -->
<!--           class="items-start self-start w-full h-auto" -->
<!--         > -->
<!--           <CardTitle -->
...
<!--           <CardTitle -->
<!--             ><img class="w-8 inline-block" :src="reviewIcon" /> Customer Reviews -->
<!--             ({{ reviews.length }})</CardTitle -->
<!--           > -->
<!--           <div v-if="reviewsLoading" class="text-sm text-slate-500 mt-2"> -->
<!--             Loading reviews... -->
<!--           </div> -->
...
<!--               :key="review.id" -->
<!--               class="border rounded-lg p-4 mt-3" -->
<!--             > -->
...
<!--                           class="object-cover h-full rounded-lg cursor-pointer" -->
<!--                           alt="Review image" -->
<!--                         /> -->
<!--                       </AspectRatio> -->
<!--                     </HoverCardTrigger> -->
...
<!--                 :default-page="1" -->
<!--                 @update:page="currentReviewPage = $event" -->
<!--               > -->
<!--                 <PaginationContent> -->
<!--                   <PaginationPrevious /> -->
<!--                   <PaginationItem -->
