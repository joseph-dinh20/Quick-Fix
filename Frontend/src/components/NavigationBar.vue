            ...
            <template v-if="isLoggedIn">
              ...
              <NavigationMenuItem>
                ...
                >
                  ...
                  <!-- Job Applications link — only for non-providers (customers) -->
                  <NavigationMenuListItem class="py-1.5" href="#/ClientJobApplications" title="Job Applications" v-if="isCustomer"/>
